...
class BamlSyncClient:
    ...
    def EvaluateEquivalence(self, contract_a: types.Contract,contract_b: types.Contract,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="EvaluateEquivalence", args={
...
class BamlStreamClient:
    ...
    def EvaluateEquivalence(self, contract_a: types.Contract,contract_b: types.Contract,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.EquivalenceVerdict, types.EquivalenceVerdict]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="EvaluateEquivalence", args={
            "contract_a": contract_a,"contract_b": contract_b,
        })
        return baml_py.BamlSyncStream[stream_types.EquivalenceVerdict, types.EquivalenceVerdict](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def EvaluateEquivalence(self, contract_a: types.Contract,contract_b: types.Contract,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="EvaluateEquivalence", args={
            "contract_a": contract_a,"contract_b": contract_b,
        }, mode="request")
        return __result__
